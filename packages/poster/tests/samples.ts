...
const ORDINARY: PosterInput[] = [
  ...
  {
    wikidataId: 'Q-siebente',
    title: 'Det sjunde inseglet',
    releaseYear: 1957,
    director: 'Ingmar Bergman',
  },
  {
    wikidataId: 'Q-nostalghia',
    title: 'Nostalghia',
    releaseYear: 1983,
  ...
  {
    wikidataId: 'Q-shoplift',
    title: 'Shoplifters – Familienbande',
    releaseYear: 2018,
